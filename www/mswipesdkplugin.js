...
MswipeSDKPlugin.prototype.printText = function(
text, align, size, onResponseCallBack) {
  ...
  cordova.exec(onResponseCallBack, onResponseCallBack, 'MswipeSDKPlugin', "printtext", [options]);

}


MswipeSDKPlugin.prototype.printImage = function(
bitmap, align, onResponseCallBack) {

        console.log('printImage: ' + bitmap );
  ...
  cordova.exec(onResponseCallBack, onResponseCallBack, 'MswipeSDKPlugin', "printimage", [options]);
